...
// slider gallery
const cards = document.querySelectorAll('.gallery__container_img');
const sliderLine = document.querySelector('.gallery__container_show');
...
function showSlides(n) {
    let i;
    let slides = document.getElementsByClassName('press__container_text');
